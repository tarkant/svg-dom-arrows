...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar TO_COMPARE = ['x', 'y', 'width', 'height'];\r\nvar comparePositions = function (prev, node) {\r\n    var rect = node.getBoundingClientRect();\r\n    return {\r\n        equal: !TO_COMPARE.some(function (prop) { return prev[prop] !== rect[prop]; }),\r\n        rect: rect,\r\n    };\r\n};\r\nvar nextPositions = function (_a) {\r\n    var prevs = _a.prevs, from = _a.from, to = _a.to;\r\n    var current = {};\r\n    current.from = comparePositions(prevs.from, from.node);\r\n    current.to = comparePositions(prevs.to, to.node);\r\n    if (current.from.equal && current.to.equal)\r\n        return null;\r\n    return {\r\n        from: current.from.rect,\r\n        to: current.to.rect,\r\n    };\r\n};\r\nvar observer = function (from, to) {\r\n    var prevs = { from: {}, to: {} };\r\n    var callback = null;\r\n    var timer = setInterval(function () {\r\n        if (!document.body.contains(from.node.parentNode)\r\n            || !document.body.contains(to.node.parentNode)) {\r\n            clearInterval(timer);\r\n            return;\r\n        }\r\n        var next = nextPositions({ prevs: prevs, from: from, to: to });\r\n        if (!next)\r\n            return;\r\n        prevs.from = next.from;\r\n        prevs.to = next.to;\r\n        if (callback)\r\n            callback();\r\n    }, 150);\r\n    var observe = function (handler) {\r\n        callback = handler;\r\n    };\r\n    return {\r\n        observe: observe,\r\n        timer: timer,\r\n    };\r\n};\r\n/* harmony default export */ __webpack_exports__[\"default\"] = (observer);\r\n\n\n//# sourceURL=webpack:///./src/observer/observer.ts?");
